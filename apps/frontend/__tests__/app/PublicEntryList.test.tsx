...
describe('PublicEntryList', () => {
  describe('コンポーネントの基本構造', () => {
    it('PublicEntryListファイルが存在すること', () => {
      ...
      const componentPath = path.join(__dirname, '../../src/app/PublicEntryList.tsx')
  ...
  describe('TypeScript型安全性', () => {
    ...
    it('ESLint無効化コメントが適切に使用されていること', () => {
      ...
      expect(content).toContain('eslint-disable-next-line @typescript-eslint/no-explicit-any')
    })
  })
})
