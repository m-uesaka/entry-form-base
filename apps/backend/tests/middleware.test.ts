...
import { dbMiddleware, sanitizeMiddleware, type Env, type Variables } from "../src/middleware";
...
describe("Middleware Tests", () => {
  ...
  describe("sanitizeMiddleware", () => {
    ...
    it("should sanitize participant data correctly", async () => {
      ...
      expect(data).toHaveProperty("lastNameKanji", mockParticipant.lastNameKanji);
      expect(data).toHaveProperty("firstNameKanji", mockParticipant.firstNameKanji);
    });
    ...
    it("should sanitize participants array correctly", async () => {
      ...
      const participants = [mockParticipant, { ...mockParticipant, id: 2, email: "test2@example.com" }];
